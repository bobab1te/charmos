    ...
    <div className="relative flex min-h-screen items-center justify-center px-4 py-10">
      <div className="charm-glass max-w-md rounded-3xl p-8 text-center">
        ...
        <p className="mt-2 text-sm text-[var(--charm-ink-soft)]">
          ...
          <code className="rounded bg-[var(--surface-nested)] px-1 py-0.5 text-xs">docs/supabase-setup.md</code> in the project,
          then add <code className="rounded bg-[var(--surface-nested)] px-1 py-0.5 text-xs">VITE_SUPABASE_URL</code> and{' '}
          <code className="rounded bg-[var(--surface-nested)] px-1 py-0.5 text-xs">VITE_SUPABASE_ANON_KEY</code> to your{' '}
          <code className="rounded bg-[var(--surface-nested)] px-1 py-0.5 text-xs">.env</code> file, then restart the dev server.
        </p>
      </div>
    </div>
  )
